...
def update_product(db: Session, id: int, patch):
    """
    Update product by id.

    Accepts either:
      - a Pydantic model (with .dict()), or
      - a plain dict of fields.
    ...
    # Apply updates; keep sku_lower in sync when sku changes
